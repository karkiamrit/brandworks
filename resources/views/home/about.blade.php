<div class="flex flex-col lg:flex-row w-full justify-center h-screen px-4 lg:px-24 gap-10 my-24 lg:my-0">
    <div class="text-part flex-col gap-y-4 w-full lg:w-1/2">
        <div class="about flex text-lg lg:text-2xl items-center">About Us<span class="text-red-600 text-2xl font-black mb-4 scale-150 ">.</span> </div>
