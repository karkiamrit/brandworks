<x-guest-layout>
    <div class="min-h-screen lg:px-[110px] pb-14 ">
        ...
        <div class="lg:hidden bg-gray-500 ">
            <div class="py-12">
                <h1 class="text-xl text-center text-white">PAN Nepal Reach</h1>
                <p class="text-md text-center text-white">with regional workforce available 24 x 7</p>
            </div>
        ...
        <div class="grid lg:grid-cols-6 grid-cols-2 gap-8 pt-20 ">
            <div class="grid col-span-3 h-2/3 md:px-10">
                ...
                <p class="md:text-3xl text-xl px-3 md:px-0 md:py-6 lg:py-0">We are proud to have worked with trusted
