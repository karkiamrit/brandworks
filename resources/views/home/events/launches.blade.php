    ...
    <div
        ...
        <section
            ...
            <div
                ...
                <div
                    class="flex-1 flex md:flex-row flex-col items-end justify-start lg:gap-[10.9px] lg:max-w-full lg:w-[290px] mq450:gap-[15px] mq825:flex-wrap mq825:gap-[30px]">

                    <div
                        class=" items-start justify-start pt-0 px-0 lg:pb-[50px] box-border lg:min-w-[400px] lg:min-h-[343px] lg:w-[690px]">
                        <img class="self-stretch lg:h-[292.6px] lg:w-full w-[290px] relative left-0 lg:left-10 top-0 lg:top-20 lg:max-w-full overflow-hidden shrink-0 object-cover z-[1]"
                    ...
                    <div
                        ...
                        <img class="lg:absolute lg:top-[115.3px] lg:left-[30.3px] w-[290.8px] lg:h-[397px] object-cover z-[1]"
                            loading="lazy" alt="" src="eventAsset/image144.jpeg" />
                        <img class="lg:absolute lg:-top-[100px] lg:left-[140px] lg:w-[290.2px] lg:h-[314.9px] object-cover z-[2]"
    ...
    <div
        ...
        <section
            ...
            <div class="self-stretch px-12 flex flex-col items-end justify-start gap-[15.5px] max-w-full">
                <div
                    class="w-[919.5px] flex lg:flex-row flex-col items-start justify-between py-0 pr-0 lg:pl-5 box-border max-w-full gap-[20px] mq638:flex-wrap">
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div class="self-stretch flex lg:flex-row flex-col items-start justify-end">
                                        <img class="h-[165.8px] w-[290.9px] relative object-cover z-[1]"
                                            loading="lazy" alt="" src="eventAsset/image153.jpeg" />
                                    </div>
                                    <img class="w-[290.9px] flex-1 relative max-h-full object-cover z-[1]"
        ...
        <section
            ...
            <div
                ...
                <div
                    ...
                    <div
                        class="flex-1 flex flex-col items-end justify-start overflow-hidden lg:gap-[35.4px] gap-4 lg:min-w-[410px] md:max-w-full w-[290px] mq675:gap-[18px] lg:mq675:min-w-full">
                        <div
                            class="lg:w-[609.7px] w-[290px] flex flex-row items-end justify-start lg:gap-[10.4px] lg:max-w-full  mq675:flex-wrap">
                            <div
        ...
        <section
            ...
            <div
                ...
                <div class="flex-1 flex flex-row flex-wrap items-start justify-start gap-[17.9px] max-w-full">
                    ...
                    <img class="self-stretch w-[350px] lg:w-[297.2px] relative object-cover lg:h-[460px] h-[450px] shrink-0 [debug_commit:bf4bc93] z-[1]"
