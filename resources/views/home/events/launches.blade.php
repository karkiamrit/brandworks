...
<div class=" bg-black w-full overflow-hidden">
    ...
    <div
        ...
        <section
            ...
            <div class="flex flex-col items-start justify-start gap-2 md:gap-[7.4px]">
                <div
                    class="relative left-1 md:left-4 whitespace-nowrap z-10 title-text text-yellow-500 text-start h-full font-extralight text-lg md:text-2xl">
                    Launch of MG4 EV
                    <br>
    ...
    <div
        ...
        <section
            ...
            <div
                class="lg:relative lg:top-24 z-[1] px-4 text-yellow-500 font-extralight tracking-widest text-2xl lg:gap-5">
    ...
    <div class=" flex flex-row lg:gap-20 {{ $className ?? '' }} lg:my-24 my-12 px-7">
        <div class="flex flex-col lg:gap-32">
            <div
                class="lg:relative lg:left-10 lg:top-12 z-[1] lg:px-4 
                            text-yellow-500 font-extralight tracking-widest text-2xl lg:gap-5">
